programa
{
	 ...
	 * quilo excedente. João precisa que você faça um sistema que leia a variável P (peso de tomates) 
	...
	funcao inicio()
	{
		real peso, excesso, vMulta=0.0, vKg=4.00, limiteKg=50.0

		escreva("Quantos kg de tomates você trouxe: ")
		leia(peso)

		se(peso>limiteKg)
		{
			excesso=(peso-limiteKg)
			vMulta=(excesso*vKg)
			escreva("Joao, sua multa é de ",vMulta," reais.")
		}
		senao
		escreva("Joao, sua multa é de ", vMulta," reais.")
