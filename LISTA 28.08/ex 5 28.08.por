programa
{
	...
	funcao inicio()
	{
		...
		escreva("Digite a quantidade de poluição: ")
		leia(indiceP)

		se(indiceP>=0.0 e indiceP<=0.29)
		{
			escreva("As atividades podem continuar.")
		}
		se(indiceP>=0.3 e indiceP<0.49)
		{
			escreva("As atividades serão suspensas.")
		}
		se(indiceP>=0.5)
		{
			escreva("As atividades devem parar.")
		}
